...
class Empleado implements EmployeeType {
    name: string;
    id: string;
    salary: number;
  
    constructor(private name: string, private id: string, salary: number) {
      this.name = name;
      this.id = id;
      this.salary = salary;
    }
  ...
  class Gerente extends Empleado implements EmployeeType{
